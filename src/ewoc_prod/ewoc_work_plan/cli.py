...
from .utils import set_logger, MutuallyExclusiveOption
...
@click.option("-prov_s2", help="S2 Provider (peps/creodias/astraea_eod)", multiple=True)
@click.option("-prov_s1", help="S1 Provider (creodias/astraea_eod)")
